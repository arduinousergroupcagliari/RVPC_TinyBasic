...
#define STR_EDITION "RVPC"
#define STR_CONTRIB "by augc.it"

//void video_putch(uint8_t);
//void video_newline(void);
#define video_newline( ) cursor_down()

// Terminal control
#define c_putch(c) write(c) //video_putch(c)
#define c_getch( ) kbd_read()
#define c_kbhit( ) kbd_handle()
...
/* disattivati per risparmiare spazio
void isave() {
